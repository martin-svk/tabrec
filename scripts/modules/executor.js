...
(function() {
  ...
  this.Executor = (function() {
    var _dbg_mode, _tabs, _tabs_backup, clear_arrays, get_domain, handle_multi_activate_pattern, revert_multi_activate_pattern, sort_by_domains, sort_tabs_by_domains;
    ...
    sort_tabs_by_domains = function(tabs) {
      var _tabs_ordered, i, ids, len, tab, url;
      _tabs_ordered = [];
